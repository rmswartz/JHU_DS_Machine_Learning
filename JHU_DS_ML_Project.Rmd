...
```{r cleaning, cache = TRUE, warning = FALSE}
...
```{r nzc, cache = TRUE, warning = FALSE}
set.seed(19428)
...
<center>
<fig>
```{r mosaic, warning = FALSE, fig.width = 5, fig.height = 5}
...
```{r remove objects, cache = TRUE, warning = FALSE}
...
```{r model 3, cache = TRUE, warning = FALSE}
set.seed(19428)
...
```{r model 4, cache = TRUE, warning = FALSE}
set.seed(19428)
...
```{r confusion matrices, cache = TRUE, warning = FALSE}
...
```{r final test, cache = TRUE, warning = FALSE}
